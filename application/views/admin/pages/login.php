                    ...
                    <form id="adminlogincheck" class="form-horizontal" action="<?php echo base_url() ?>admin_login_check" method="post">
                        <fieldset>
                            ...
                            <div class="input-prepend" title="User Email">
                                ...
                                <input class="input-large span10" value="<?php set_value('user_name'); ?>" name="user_email" id="user_email" type="text" placeholder="ketikkan username" />
                            </div>
                            <div class="clearfix"></div>

                            <div class="input-prepend" title="User Password">
                                <span class="add-on"><i class="halflings-icon lock"></i></span>
                                <input class="input-large span10" name="user_password" id="user_password" type="password" placeholder="Ketikkan Password" />
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="button-login">
                                <button type="submit" class="btn btn-primary adminlogincheck">Masuk</button>
                            </div>
                            <div class="clearfix"></div>
                        </fieldset>
