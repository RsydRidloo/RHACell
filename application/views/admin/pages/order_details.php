...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/order') ?>">Detail pesanan</a></li>
    </ul>

    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Detail pesanan</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <div class="span4 text-left">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td>Ponsel Pelanggan : </td>
                            <td><?php echo $customer_info->customer_phone; ?></td>
                        </tr>
                        <tr>
                            <td>Surel pelanggan : </td>
