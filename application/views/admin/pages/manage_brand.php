...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/brand') ?>">Kelola Merek</a></li>
    </ul>

    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Kelola Merek</h2>
                <div class="box-icon">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <?php if ($single_brand->publication_status == 1) { ?>
                                        <span class="label label-success">Sudah dipublikasi</span>
                                    <?php } else {
                                    ?>
                                        <span class="label label-danger" style="background:red">Belum Dipublikasi</span>
                                    <?php }
                                    ?>
                                </td>
                                <td class="center">
